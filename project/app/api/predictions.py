...
from app.models.pydantic import PredictionResponseSchema, PredictionSchema, PredictionUpdateSchema
...
async def create_prediction(
    ...
    prediction_id = await crud.create(
        session, file.filename, upload_path
    )  # ADD session
...
async def update_prediction(
    ...
    updated = await crud.update(
        session, id, payload.top_prediction, payload.confidence, None
    )  # ADD session
    return updated
